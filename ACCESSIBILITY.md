...
- **Keyboard Navigation**: All interactive elements (drawers, modals, 3D controls, variant swatches) are fully reachable and operable via keyboard.
...
- **Reduced Motion**: Respects `prefers-reduced-motion: reduce` by dampening transitions, halting 3D auto-rotation, and disabling sliding effects.
